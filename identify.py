...
def process_file(filename):
	...
	global last_unknown,last_known
        if result.TRID:
                ...
                if ((last_known == 0) or (last_known != track_id)) and moreThanMatchesInLastTracks(track_id,0):
                        last_known=track_id
...
if __name__ == "__main__":
	...
	logfile = open(workspace+"Reklama/logs/radio"+radio+"TestIdentify"+getNowDateTime(), 'w',1)
